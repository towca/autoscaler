...
func TestFindEmptyNodes(t *testing.T) {
	...
	r := NewRemovalSimulator(nil, &clustersnapshot.Handle{ClusterSnapshot: clusterSnapshot}, nil, nil, testDeleteOptions(), nil, false)
...
func TestFindNodesToRemove(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := NewRemovalSimulator(registry, &clustersnapshot.Handle{ClusterSnapshot: clusterSnapshot}, predicateChecker, tracker, testDeleteOptions(), nil, false)
