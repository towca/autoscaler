...
func TestBinpackingEstimate(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			clusterSnapshot.AddNode(&clustersnapshot.NodeResourceInfo{Node: makeNode(100, 100, 10, "oldnode", "zone-jupiter")})
			...
			estimator := NewBinpackingNodeEstimator(predicateChecker, &clustersnapshot.Handle{ClusterSnapshot: clusterSnapshot}, limiter, processor, nil /* EstimationContext */, nil /* EstimationAnalyserFunc */)
